...
<template>
    <div class="sidebar">
      <Button label="Agregar nuevo paciente" class="p-button-rounded add-patient-button" icon="pi pi-plus" />
      <ul class="menu">
        ...
        <li class="menu-item"><i class="pi pi-user"></i><h3>Perfil</h3></li>
        <li class="menu-item"><i class="pi pi-users"></i><h3>Pacientes</h3></li>
        <li class="menu-section">SHOP</li>
        <li class="menu-item"><i class="pi pi-folder"></i><h3>Productos</h3></li>
        <li class="menu-item"><i class="pi pi-bell"></i><h3>Ordenes</h3></li>
        <li class="menu-item"><i class="pi pi-file"></i><h3>Reporte</h3></li>
      </ul>
